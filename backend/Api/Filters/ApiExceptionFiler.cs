...
public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
{
    public override void OnException(ExceptionContext context)
    {
        switch (context.Exception)
        {
            ...
            case UnprocessableEntityException unprocessableEx:
                HandleUnprocessableEntityException(context, unprocessableEx);
                break;
            default:
    ...
    private static void HandleConflictException(ExceptionContext context, ConflictException exception)
    {
        var details = new ProblemDetails
        {
            Title = "Conflict",
    ...
    private static void HandleUnprocessableEntityException(ExceptionContext context, UnprocessableEntityException exception)
    {
        var details = new ProblemDetails
        {
